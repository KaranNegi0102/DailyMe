  ...
  return (
    <div className="min-h-screen bg-[#f6ebeb] text-black flex flex-col p-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl mx-auto">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center bg-white rounded-lg shadow-md p-6">
          ...
          <input
            ...
            className="mb-4"
          />
          <div className="w-full h-48 flex items-center justify-center bg-gray-100 rounded-md border text-gray-400">
            No image preview
          </div>
        </div>
      </div>
