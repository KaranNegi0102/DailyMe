    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 delius-swash-caps-regular">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
          ...
          <p className="text-xl text-gray-700 delius-swash-caps-regular">
            {error}
          </p>
        </div>
      </div>
        ...
        <div className="relative z-10 container mx-auto px-6 ">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl  text-gray-600 delius-swash-caps-mix max-w-2xl mx-auto">
              Where Pixels Meet Poetry - Discover Amazing Stories from Our
              Community
            </p>
          </div>
        ...
        {showRandom && randomBlog ? (
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Here&apos;s something special we picked just for you
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                The community&apos;s favorite reads
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Explore our entire collection of amazing stories
              </p>
            </div>
            {blogs.map((blog, idx) => (
              <BlogCard key={blog.id} blog={blog} index={idx} />
